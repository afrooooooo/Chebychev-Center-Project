# Chebyshev Center Optimization Project
...
## Files
- `chebyshev_center.ipynb`: Main implementation and visualization

## Author Comments
Graduate-level optimization project using Python and numerical methods.
